...
if __name__ == "__main__":
    ...
    # for i, D in enumerate(Dtype_list):
        ...
        # for j, alpha in enumerate(sus_array[i]):
            ...
            # plt.savefig("dialysis/plots/B_N0_countplot_D{}_R0{}_scenario{}.png".format(i, R0, s))
            # plt.close()
    ...
    # for i, D in enumerate(Dtype_list):
        ...
        # for j, alpha in enumerate(sus_array[i]):
            ...
            # plt.savefig("dialysis/plots/countplot_D{}_R0{}_scenario{}.png".format(i, R0, s))
            # plt.close()
    ...
    for i, D in enumerate(Dtype_list):
        ...
        for j, alpha in enumerate(sus_array[i]):
            ...
            # plt.legend(handles=[p1,p2,p3,p4], loc='best')
            plt.savefig("dialysis/plots/day{}/countplot_D{}_R0{}_scenario{}.png".format(day, i, R0, s))
            plt.close()

    ###################################
    # Used this figure in the paper instead of count plot
    ###################################
    ...
    for i, D in enumerate(Dtype_list):
        ...
        for j, alpha in enumerate(sus_array[i]):
            ...
            # plt.legend(handles=[p1,p2,p3,p4], loc='best')
            plt.savefig("dialysis/plots/day{}/histogram_D{}_R0{}_scenario{}.png".format(day, i, R0, s))
    ...
    for i, D in enumerate(Dtype_list):
        ...
        for j, alpha in enumerate(sus_array[i]):
            ...
            plt.grid(zorder=0)
            plt.savefig("dialysis/plots/day{}/B_N0_D{}_R0{}_scenario{}.png".format(day, i, R0, s))
            plt.close()
    ...
    for i, D in enumerate(Dtype_list):
        ...
        for j, alpha in enumerate(sus_array[i]):
            ...
            plt.xticks(range(1, 31), xticklabels)
            plt.grid(zorder=0)
            plt.savefig("dialysis/plots/day{}/B_N1_D{}_R0{}_scenario{}.png".format(day, i, R0, s))
            plt.close()
    ...
    for i, D in enumerate(Dtype_list):
        ...
        for j, alpha in enumerate(sus_array[i]):
            ...
            plt.xticks(range(1, 31), xticklabels)
            plt.grid(zorder=0)
            plt.savefig("dialysis/plots/day{}/B_H0_H1_D{}_R0{}_scenario{}.png".format(day, i, R0, s))
            plt.close()
    ...
    for i, D in enumerate(Dtype_list):
        ...
        for j, alpha in enumerate(sus_array[i]):
            ...
            plt.xticks(range(1, 31), xticklabels)
            plt.grid(zorder=0)
            plt.savefig("dialysis/plots/day{}/median_B_H0_H1_D{}_R0{}_scenario{}.png".format(day, i, R0, s))
            plt.close()
    ...
    for i, D in enumerate(Dtype_list):
        ...
        for j, alpha in enumerate(sus_array[i]):
            ...
            plt.xticks(range(1, 31), xticklabels)
            plt.grid(zorder=0)
            plt.savefig("dialysis/plots/day{}/B_P2_H2P2_D{}_R0{}_scenario{}.png".format(day,i, R0, s))
            plt.close()
    ...
    for i, D in enumerate(Dtype_list):
        ...
        for j, alpha in enumerate(sus_array[i]):
            ...
            plt.xticks(range(1, 31), xticklabels)
            plt.grid(zorder=0)
            plt.savefig("dialysis/plots/day{}/median_B_P2_H2P2_D{}_R0{}_scenario{}.png".format(day,i, R0, s))
            plt.close()
    ...
    for i, D in enumerate(Dtype_list):
        ...
        for j, alpha in enumerate(sus_array[i]):
            ...
            plt.xticks(range(1, 31), xticklabels)
            plt.grid(zorder=0)
            plt.savefig("dialysis/plots/day{}/B_H3P1_D{}_R0{}_scenario{}.png".format(day,i, R0, s))
            plt.close()
    ...
    for i, D in enumerate(Dtype_list):
        ...
        for j, alpha in enumerate(sus_array[i]):
            ...
            plt.xticks(range(1, 31), xticklabels)
            plt.grid(zorder=0)
            plt.savefig("dialysis/plots/day{}/B_Bp_Bpp_Bppp_D{}_R0{}_scenario{}.png".format(day,i, R0, s))
            plt.close()
    ...
    for i, D in enumerate(Dtype_list):
        ...
        for j, alpha in enumerate(sus_array[i]):
            ...
            plt.xticks(range(1, 31), xticklabels)
            plt.grid(zorder=0)
            plt.savefig("dialysis/plots/day{}/median_B_Bp_Bpp_Bppp_D{}_R0{}_scenario{}.png".format(day,i, R0, s))
            plt.close()
    ...
    for i, D in enumerate(Dtype_list):
        ...
        for j, alpha in enumerate(sus_array[i]):
            ...
            plt.xticks(range(1, 31), xticklabels)
            plt.grid(zorder=0)
            plt.savefig("dialysis/plots/day{}/transmission_route_D{}_R0{}_scenario{}.png".format(day, i, R0, s))
            plt.close()
